...
const WhatsAppBtn = () => {
  // REEMPLAZA ESTE NÚMERO con el tuyo (código de país + número, sin espacios)
  // Ejemplo México: 521 + 10 dígitos -> 5218112345678
  const phoneNumber = "528116271817"; 
  const message = "Hola, me gustaría agendar una cita de biomagnetismo.";
  ...
  return (
    ...
    >
      {/* Icono de WhatsApp (SVG directo para no cargar imágenes externas) */}
      <svg 
